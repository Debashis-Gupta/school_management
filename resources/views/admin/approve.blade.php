                ...
                <form method="POST" action="{{asset('/admin/final')}}">
                    ...
                    @foreach($two as $two)
                        <div class="form-group row">
                            ...
                            <div class="col-sm-3">
                                <input type="text" name="applicant_id" class="form-control" id="inputEmail3"
                        ...
                        <div class="form-group row">
                            <div class="form-group col-md-5">
                                ...
                                <input type="text" name="roll" class="form-control" id="inputEmail3"
                                       placeholder="Enter the roll" required>
                        ...
                        <div class="form-group row">
                            <div class="form-group col-md-5">
                                ...
                                <input type="text" name="class" class="form-control" id="inputEmail3"
                                       value="{{$two->class}}">

                            </div>
                            <div class="form-group col-md-5">
                                <label for="disabledSelect">Group</label>
                                <input type="text" name="group" class="form-control" id="inputEmail3"
                                       value="{{$two->group}}">
                            </div>
                        </div>
                        <div class="form-group row">
                        ...
                        <div class="form-group row">
                            <div class="form-group col-md-5">
                                ...
                                <input type="" name="father_cell" class="form-control" id=""
                                       value="{{$two->father_mobile}}">
                            </div>
                            <div class="form-group col-md-5">
                                <label for="">Mother's CellNumber</label>
                                <input type="" name="mother_cell" class="form-control" id=""
                                       value="{{$two->mother_mobile}}">
                            </div>
                        ...
                        <div class="form-group row">
                            <div class="form-group col-md-5">
                                ...
                                <input type="text" name="father_sal" class="form-control" id=""
                                       value="{{$two->father_income}}">
                            </div>
                            <div class="form-group col-md-5">
                                <label for="">Mother's Salary</label>
                                <input type="text" name="mother_sal" class="form-control" id=""
                                       value="{{$two->mother_income}}">
                            </div>
                        ...
                        <div class="form-group row">
                            ...
                            <div class="form-group col-md-4">
                                ...
                                <input type="" name="nationality" class="form-control" id=""
                                       value="{{$two->nationality}}">
                            </div>
                        ...
                        <div class="form-group row">
                            <div class="form-group col-md-5">
                                ...
                                <input type="text" name="pi" class="form-control" id="inputCity"
                                       value="{{$two->previous_institute}}">
                            </div>

                            <div class="form-group col-md-4">
                                <label for="inputCity">Contact Number</label>
                                <input type="text" name="cn" class="form-control" id="inputCity"
                                       value="<?php echo '0'?>{{$two->contact_no}}">
                            </div>
                            <label style="margin-left:18px;" for="">Autistic</label>
                            <div class="form-check col-md-3">
                                <div class="form-group">
                                    <input style="width:100px;" type="text" name="aust" class="form-control"
                                           id="inputCity" value="{{$two->autistic}}">
                        ...
                        <div class="form-group"style="margin-left: 15px;">
                            ...
                            <input type="text" name="image" class="form-control-file" id="exampleFormControlFile1" value="{{$two->image}}" >
                        </div>
                    @endforeach
                    <button style="margin-bottom:20px;" class="btn btn-primary pull-left" type="submit">Approve The
                        Applicant
                    </button>
                </form>
            </div>
