      ...
      <div class="inner_section clearfix">
        ...
        <form method="POST" action="{{asset('form')}}" enctype="multipart/form-data">
          ...
          <div class="form-group row">
           ...
           <div class="col-sm-10">
             <input type="text" name="applicant_name" class="form-control" id="inputEmail3" placeholder="Must be in block letter" required>
           </div>
         </div>
         <div class="form-group row">
         ...
         <input type="text" class="form-control" name="father_name"id="" placeholder="Must be in block letter"required>
       </div>
       <div class="form-group col-md-6">
         <label for="">Mother's Name</label>
         <input name="mother_name" type="text" class="form-control" id="" placeholder="Must be in block letter" required>
       </div>
        ...
        <input type="text" name="father_prof"class="form-control" id="" placeholder="Must be in block letter" required>
      </div>
      <div class="form-group col-md-6">
        <label for="">Mother's Profession</label>
        <input type="text" name="mother_prof" class="form-control" id="" placeholder="Must be in block letter" required>
      </div>
       ...
       <input type="" name="father_cell" class="form-control" id="" placeholder="+8801xxxxxxxxx" required>
     </div>
     <div class="form-group col-md-6">
       <label for="">Mother's CellNumber</label>
       <input type="" name="mother_cell"class="form-control" id="" placeholder="+8801xxxxxxxxx" required>
     </div>
      ...
      <input type="text"  name="father_sal" class="form-control" id="" placeholder="Monthly Income" required>
    </div>
    <div class="form-group col-md-6">
   ...
   <h4>Permanent Address</h4>
    <div class="form-group row">
        ...
        <div class="form-group col-md-4">
          ...
          <input type="text" name="village" class="form-control" id="inputCity" placeholder="Enter village name" required>
        </div>
        <div class="form-group col-md-4">
          <label for="inputState">Post Office</label>
          <input type="text" name="po" class="form-control" id="inputZip" placeholder="Enter post office name" required>
        </div>
        <div class="form-group col-md-4">
          <label for="inputZip">Post Code</label>
          <input type="text" name="pc" class="form-control" id="inputZip"placeholder="Enter post code number">
        </div>
        <div class="form-group col-md-6">
          <label for="inputCity">Upazilla</label>
          <input type="text" name="upalzilla" class="form-control" id="inputCity" placeholder="Enter Upazilla name" required>
        </div>
        <div class="form-group col-md-6">
          <label for="inputCity">District</label>
          <input type="text" name="dist" class="form-control" id="inputCity" placeholder="Enter District name" required>
        </div>
    ...
    <div class="form-group col-md-4">
      ...
      <input type="text" name="cn" class="form-control" id="inputCity" placeholder="+8801xxxxxxxxx" required>
    </div>
